...
var Tab = {
	addTab: function(title, url) {
		base_Url="http://localhost:8080/OESPF_war_exploded/statics/html"
		...
		if ($('#tab_' + index).length == 0) {
			...
			var iframe = '<div id="iframe_' + index + '" class="iframe cur"><iframe class="tab_iframe" src="' +base_Url+ url +'" width="100%" frameborder="0" scrolling="auto" onload="changeFrameHeight(this)"></iframe></div>';
